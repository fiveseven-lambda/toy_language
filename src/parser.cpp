...
namespace parser {
    std::unique_ptr<type::Type> parse_type(lexer::Lexer &lexer){
    ...
    static std::unique_ptr<expression::Expression> parse_factor(lexer::Lexer &), parse_binary_operator(lexer::Lexer &, int precedence);
    static std::vector<std::unique_ptr<expression::Expression>> parse_arguments(lexer::Lexer &);
    ...
    std::unique_ptr<expression::Expression> parse_binary_operator(lexer::Lexer &lexer, int current_precedence){
    ...
    std::unique_ptr<expression::Expression> parse_expression(lexer::Lexer &lexer){
        return parse_binary_operator(lexer, 0);
    }

    std::vector<std::unique_ptr<expression::Expression>> parse_arguments(lexer::Lexer &lexer){
    ...
    std::unique_ptr<sentence::Sentence> parse_sentence(lexer::Lexer &lexer){
